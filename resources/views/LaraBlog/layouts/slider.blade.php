    ...
    <div class="container" data-aos="fade-up" data-aos-delay="100">
      ...
      <div class="swiper init-swiper">
        ...
        <div class="swiper-wrapper">
          ...
          <div class="swiper-slide" style="background-image: url('frontend/img/post-slide-1.jpg');">
            <div class="content">
          ...
          <div class="swiper-slide" style="background-image: url('frontend/img/post-slide-2.jpg');">
            <div class="content">
          ...
          <div class="swiper-slide" style="background-image: url('frontend/img/post-slide-3.jpg');">
            <div class="content">
          ...
          <div class="swiper-slide" style="background-image: url('frontend/img/post-slide-4.jpg');">
            <div class="content">
