                    ...
                    <div class="row g-5">
                        <div class="col-lg-4">
                            ...
                            <div class="post-entry lg">
                                <a href="{{ route('blog-details', $posts[0]->slug) }}"><img
                                        src="frontend/img/post-landscape-1.jpg" alt="" class="img-fluid"></a>
                                <div class="post-meta"><span
                                        class="date">{{ $posts[0]->blogCategory[0]->getCategoryName->category_name }}</span>
                                ...
                                <div class="d-flex align-items-center author">
                                    <div class="photo"><img src="frontend/img/person-1.jpg" alt=""
                                            class="img-fluid"></div>
                                    <div class="name">
                                ...
                                <div class="row g-5">
                                    <div class="col-lg-6 border-start custom-border">
                                        <div class="post-entry">
                                            <a href="blog-details.html"><img src="frontend/img/post-landscape-2.jpg"
                                                    alt="" class="img-fluid"></a>
                                            <div class="post-meta"><span
                                                    class="date">{{ $posts[0]->blogCategory[0]->getCategoryName->category_name }}</span>
                                                <span class="mx-1">•</span> <span>J{{ $posts[0]->created_at }}</span></div>
                                            <h2><a href="blog-details.html">{{ $posts[0]->title }}</a></h2>
                                        </div>
                                        <div class="post-entry">
                                            <a href="blog-details.html"><img src="frontend/img/post-landscape-5.jpg"
                                                    alt="" class="img-fluid"></a>
                                        ...
                                        <div class="post-entry">
                                            <a href="blog-details.html"><img src="frontend/img/post-landscape-7.jpg"
                                                    alt="" class="img-fluid"></a>
                                    ...
                                    {{-- <div class="col-lg-4 border-start custom-border">
                                        <div class="post-entry">
                                            <a href="blog-details.html"><img src="frontend/img/post-landscape-3.jpg"
                                                    alt="" class="img-fluid"></a>
                                        ...
                                        <div class="post-entry">
                                            <a href="blog-details.html"><img src="frontend/img/post-landscape-6.jpg"
                                                    alt="" class="img-fluid"></a>
                                        ...
                                        <div class="post-entry">
                                            <a href="blog-details.html"><img src="frontend/img/post-landscape-8.jpg"
                                                    alt="" class="img-fluid"></a>
                    ...
                    <div class="col-md-9">
                        ...
                        <div class="d-lg-flex post-entry">
                            <a href="blog-details.html" class="me-4 thumbnail mb-4 mb-lg-0 d-inline-block">
                                <img src="frontend/img/post-landscape-6.jpg" alt="" class="img-fluid">
                            </a>
                            <div>
                                ...
                                <div class="d-flex align-items-center author">
                                    <div class="photo"><img src="frontend/img/person-2.jpg" alt=""
                                            class="img-fluid"></div>
                                    <div class="name">
                        ...
                        <div class="row">
                            <div class="col-lg-4">
                                <div class="post-list border-bottom">
                                    <a href="blog-details.html"><img src="frontend/img/post-landscape-1.jpg"
                                            alt="" class="img-fluid"></a>
                    ...
                    <div class="col-md-9 order-md-2">
                        ...
                        <div class="d-lg-flex post-entry">
                            <a href="blog-details.html" class="me-4 thumbnail d-inline-block mb-4 mb-lg-0">
                                <img src="frontend/img/post-landscape-3.jpg" alt="" class="img-fluid">
                            </a>
                            <div>
                                ...
                                <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Distinctio placeat
                                    ...
                                    deserunt aliquam temporibus sapiente, laudantium dolorum itaque libero eos deleniti?</p>
                                <div class="d-flex align-items-center author">
                                    <div class="photo"><img src="frontend/img/person-4.jpg" alt=""
                                            class="img-fluid"></div>
                                    <div class="name">
                                        <h3 class="m-0 p-0">Wade Warren</h3>
                                    </div>
                ...
                <div class="row g-5">
                    <div class="col-lg-4">
                        <div class="post-list lg">
                            <a href="blog-details.html"><img src="frontend/img/post-landscape-8.jpg" alt=""
                                    class="img-fluid"></a>
                            ...
                            <div class="d-flex align-items-center author">
                                <div class="photo"><img src="frontend/img/person-7.jpg" alt=""
                                        class="img-fluid"></div>
                                <div class="name">
                    ...
                    <div class="col-lg-8">
                        <div class="row g-5">
                            <div class="col-lg-4 border-start custom-border">
                                ...
                                <div class="post-list">
                                    <a href="blog-details.html"><img src="frontend/img/post-landscape-4.jpg"
                                            alt="" class="img-fluid"></a>
                                    <div class="post-meta"><span class="date">Lifestyle</span> <span
                                            class="mx-1">•</span> <span>Mar 15th '22</span></div>
