            ...
            <div class="row">
                <div class="col-12">
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <div class="container">
                                <form action="{{route('editor.view')}}" method="post" enctype="multipart/form-data">
                                    @csrf
                                    <div class="mb-3">
                                        <label for="exampleFormControlTextarea1" class="form-label">Title</label>
                                        <input class="form-control" name="title" type="text" placeholder="write Title" aria-label="default input example">
                                    </div>
